...
public class MessageLoggingAspect {
    ...
    @Before("execution(* uk.gov.companieshouse.advancedcompanysearchconsumer.service.Consumer.consume(..))")
    ...
    @AfterThrowing(pointcut = "execution(* uk.gov.companieshouse.advancedcompanysearchconsumer.service.Consumer.consume(..))", throwing = "error")
