...
public class LocalDeserialiser implements org.apache.kafka.common.serialization.Deserializer<String> {
    ...
    public String deserialize(String topic, byte[] data) {
        if (data == null) {
            LOGGER.info("LocalDeserialiser - deserialize(String topic, byte[] data): returning 'null'");
            return null;
        } else {
    ...
    public String deserialize(String topic, Headers headers, ByteBuffer data) {
        if (data == null) {
             LOGGER.info("LocalDeserialiser - deserialize(String topic, Headers headers, ByteBuffer data): returning 'null'");
            return null;
        }
